import { Accessor, Component, createSignal, For, ParentComponent, Show } from "solid-js";
import { Avatar, Modal, SwitchOutline } from "../common";
...
export const ModifyMemberModalWrapper: ParentComponent = (props) => {
  ...
  return (
    <div onClick={[setOpen, true]}>
      {props.children}
      <Show when={open()}>
        <ModifyMemberModal onClose={onClose} />
      </Show>
    </div>
  );
};
