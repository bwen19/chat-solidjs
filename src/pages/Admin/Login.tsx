    ...
    <div class="flex h-screen w-full items-center justify-center bg-cover bg-center bg-no-repeat px-2" style={{ "background-image": `url(${loginBgSrc})` }}>
      <div class="flex w-full max-w-md overflow-hidden rounded-lg bg-gray-300 bg-opacity-70">
        <div class="h-full w-full p-16">
          <h3 class="text-center text-2xl font-semibold text-gray-600">Administration</h3>
          <form onSubmit={handleSubmit} spellcheck={false} class="mt-10 space-y-6">
            ...
            <div class="my-1 flex items-center">
              <input id="auto-login" type="checkbox" checked={state.isAutoLogin} onChange={() => toggleAutoLogin()} class="h-4 w-4 rounded text-sky-600" />
