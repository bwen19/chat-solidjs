import { Accessor, ParentComponent, createSignal } from "solid-js";
...
const Confirm: ParentComponent<{ onConfirm: Accessor<void> }> = (props) => {
  ...
  return (
    <>
      ...
      <Modal open={open()}>
        <div use:clickOutside={() => setOpen(false)} class="flex w-80 flex-col items-center space-y-8 rounded-md bg-white py-10">
