...
const MemberItem: Component<{ item: MemberInfo }> = (props) => {
  ...
  return (
    <li class="group flex cursor-default items-center space-x-3 rounded-md py-2 px-4 hover:shadow-sm hover:shadow-gray-400 ">
...
const Members: Component = () => {
  ...
  const handleDeleteRoom = () => {
    const req: DeleteRoomRequest = { DeleteRoom: { room_id: homeState.currRoom } };
    sendMessage(req);
  };
  const handleLeaveRoom = () => {
    const req: LeaveRoomRequest = { LeaveRoom: { room_id: homeState.currRoom } };
    sendMessage(req);
  };
